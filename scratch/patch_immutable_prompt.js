...
const oldPromptRegex = /"You are a highly capable AI Orchestrator[\s\S]*?NEVER answer directly\."/;
...
3. All professional execution is handled by specialized AI Agents in the backend.
...
console.log('PATCH_PROMPT_SUCCESS');
