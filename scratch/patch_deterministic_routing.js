...
// DETERMINISTIC GUARD: Extract strict flag from the original brief (set by Orchestrator Router)
...
} else if (briefText.includes('--image-action=generate_new')) {
  actionIntent = 'generate_new_image';
} else {
  // Legacy fallback (if no strict flag is present)
...
console.log('PATCH_DETERMINISTIC_ROUTING_SUCCESS');
