...
async function main() {
  ...
  const pollRes = await fetch(`https://api.kie.ai/v1/jobs/recordInfo?taskId=dd94754c647ac7e853e5c59a9e1fa71c`, {
      headers: { 'Authorization': `Bearer ${apiKey}` }
  });
  const pollJson = await pollRes.json();
  console.log("Poll Result:", JSON.stringify(pollJson, null, 2));
}
