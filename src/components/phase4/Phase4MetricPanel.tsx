  ...
  return (
    <section className="rounded-2xl border border-slate-700/80 bg-slate-950/70">
      <div className="border-b border-slate-700/80 px-5 py-4">
        <div className="text-sm font-semibold text-white">{t("phase4.metrics.title") ?? "Chỉ số thực thi"}</div>
        <p className="mt-1 text-xs leading-5 text-slate-400">
          {t("phase4.metrics.description") ?? "Các chỉ số sức khỏe runtime chỉ đọc. Dữ liệu bị thiếu sẽ hiển thị đang chờ."}
        </p>
      </div>
