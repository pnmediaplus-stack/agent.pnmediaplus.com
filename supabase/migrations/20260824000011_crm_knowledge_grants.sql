...
-- Documents Table
GRANT SELECT, INSERT, UPDATE, DELETE ON public.crm_knowledge_documents TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.crm_knowledge_documents TO service_role;

-- Chunks Table
GRANT SELECT, INSERT, UPDATE, DELETE ON public.crm_knowledge_chunks TO authenticated;
