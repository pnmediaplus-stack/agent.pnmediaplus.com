...
revoke all on function public.phase075_n8n_append_chat_message(uuid, text, text, text, text) from public, anon, authenticated;
grant execute on function public.phase075_n8n_append_chat_message(uuid, text, text, text, text) to service_role;
